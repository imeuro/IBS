    ...
    <section id="team-content" class="section section--light" aria-labelledby="team-list-content">
      <div class="section__twocolumns">
        ...
        <div class="twocolumns-text right">
          <p>We are a <strong>team of experienced financial services technologists</strong> with a proven track record in scaling resources and successfully completing projects in the most complex scenarios. We have <strong>in-depth knowledge of banking and financial intermediation processes and an extensive Europe-wide network</strong>.</p>
        </div>
      </div>
