    ...
    <section id="partners" class="section section--light" aria-labelledby="partners-heading">
        ...
        <div class="section__partner">
          ...
          <div class="section__partner-content">
            ...
            <p>We are an exclusive partner of  <a href="https://korelabs.co/" target="_blank" rel="noopener noreferrer" title="Kore Labs - Product Lifecycle Management">KORE Labs</a>, a London-based Fintech offering the first dedicated Product Management-as-a-Service platform for the financial services industry. We support Kore Labs across all activities related to configuration, migration, and integration.</p>
