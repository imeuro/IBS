  ...
  <main>
    ...
    <section id="team" class="section section--light" aria-labelledby="team-heading">
      ...
      <hr class="ibs__divider" />
          ...
          <p><strong>IBSlab</strong>se fundó para ayudar a bancos, gestores de inversiones y aseguradoras con servicios expertos en <strong>Product Lifecycle Management</strong> (PLM), <strong>System Integration & migration</strong> (SI) y <strong>Application Management</strong> (AM), lo que permite una transformación sin fisuras en toda la empresa.</p>
    ...
    <section id="team-content" class="section section--light" aria-labelledby="team-list-content">
      <div class="section__twocolumns">
        ...
        <div class="twocolumns-text right">
          <p>Somos un <strong>equipo de expertos tecnólogos de servicios financieros</strong>, con una comprobada experiencia en escalar recursos y llevar a término con éxito los proyectos en los escenarios más complejos. Tenemos un <strong>rofundo conocimiento del sector de los servicios financieros y una amplia red</strong> en toda Europa.</p>
        </div>
      </div>
