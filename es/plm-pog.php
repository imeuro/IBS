  ...
  <main>
    ...
    <section id="plm-pog" class="section section--light" aria-labelledby="plm-pog-heading">
        ...
        <div class="section__partner">
            ...
            <p>Como <strong>partner de referencia de <a href="https://korelabs.co/" target="_blank" rel="noopener noreferrer" title="Kore Labs - Product Lifecycle Management">KORE Labs</a></strong> y expertos de la plataforma <strong><a href="https://korelabs.co/kore-prm/" target="_blank" rel="noopener noreferrer" title="KorePRM - Product Lifecycle Management">KorePRM®</a> para la gestión del ciclo de vida de productos (Product Lifecycle Management)</strong>, nos ofrecemos para las actividades de configuración y migración, poniendo particular atención a la optimización de los tiempos de realización y de la inversión económica</p>
        </div>
    </section>
    ...
    <section id="plm-pog-content" class="section section--light" aria-labelledby="plm-pog-list-content">
            ...
            <div class="vp-col vp-col--stacked">
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Todo en un mismo sitio</strong>
                  <span class="vp-desc">Una única visión de los datos, documentos y decisiones sobre productos</span>
                </div>
              </div>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Controles end-to-end</strong>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  ...
                  <span class="vp-desc">Colaboración entre equipos, unidades de negocio y divisiones</span>
                </div>
              </div>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  ...
                  <span class="vp-desc">Para adaptarse a sus productos, procesos y estructura empresarial</span>
                </div>
              </div>
            </div>
