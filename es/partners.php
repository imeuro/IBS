    ...
    <section id="partners" class="section section--light" aria-labelledby="partners-heading">
        ...
        <div class="section__partner">
          ...
          <div class="section__partner-content">
            <p>Siamo la società scelta da <a href="https://korelabs.co/" target="_blank" rel="noopener noreferrer" title="Kore Labs - Product Lifecycle Management">KORElabs</a>, azienda inglese leader globale nell'offerta di servizi di Product Management-as-a-Service finanziari e assicurativi, per supportare in esclusiva le attività di configurazione, migrazione e integrazione nella loro piattaforma.</p>
            <p><a href="https://korelabs.co/kore-prm/" target="_blank" rel="noopener noreferrer" title="KorePRM - Product Lifecycle Management">KorePRM®</a> è la prima piattaforma di Product Intelligence per il settore dei prodotti e dei servizi finanziari caratterizzata da un approccio end-to-end e dalla gestione digitale e integrata della frammentazione dei dati.<br>
            KorePRM® offre <a href="https://korelabs.co/use-cases/" target="_blank" rel="noopener noreferrer" title="KorePRM - Product Lifecycle Management">use cases</a> che consentono a più stakeholder e team di collaborare in modo efficiente e senza soluzione di continuità per gestire i prodotti e mantenere la tracciabilità audit a fini normativi.</p>
          </div>
        </div>
    ...
    <section id="plm-pog-content" class="section section--light" aria-labelledby="plm-pog-list-content">
            ...
            <div class="vp-col vp-col--stacked">
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Tutto in un unico repository</strong>
                  <span class="vp-desc">Un'unica visione di dati, decisioni, eventi e documenti relativi ai prodotti.</span>
                </div>
              </div>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Controllo completo</strong>
                  <span class="vp-desc">Ambiente digitale controllato e traccia di audit automatica.</span>
                </div>
              </div>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Aumento di produttività</strong>
                  <span class="vp-desc">Collaborazione tra aziende, funzioni aziendali, team e aree geografiche.</span>
                </div>
              </div>
              ...
              <div class="vp-cell">
                ...
                <div class="vp-text">
                  <strong>Modulare e configurabile</strong>
                  <span class="vp-desc">Per adattarsi ai vostri prodotti, ai vostri processi e alla vostra struttura aziendale.</span>
                </div>
              </div>
            </div>
