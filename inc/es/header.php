        ...
        <ul class="nav__list">
          <li class="nav__item has-submenu">
            ...
            <ul class="nav__submenu">
              <li><a href="<?php echo url('es/value-proposition'); ?>" tabindex="0">Value Proposition</a></li>
          ...
          <li class="nav__item has-submenu">
            ...
            <ul class="nav__submenu">
              <li><a href="<?php echo url('es/team'); ?>" tabindex="0">NOI</a></li>
              <li><a href="<?php echo url('es/partners'); ?>" tabindex="0">I Nostri Partner</a></li>
            </ul>
          </li>
          <li class="nav__item has-submenu">
            <a href="#contatti" tabindex="0">contatti</a>
            <ul class="nav__submenu">
              <li><a href="<?php echo url('es/contacts'); ?>" tabindex="0">Contattaci</a></li>
              <li><a href="<?php echo url('es/lavora-con-noi'); ?>" tabindex="0">Lavora con noi</a></li>
            </ul>
          </li>
        </ul>
      </nav>
