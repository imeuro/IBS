  <div class="topbar" aria-label="Selezione lingua">
    <div class="topbar__lang">
        ...
        <a href="<?php echo url('it/'); ?>" title="Versión italiana" tabindex="0" hreflang="it"><img src="<?php echo IMAGES_PATH; ?>/it.svg" alt="Bandera italiana" title="Italiano" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
