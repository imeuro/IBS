  <div class="topbar" aria-label="Selezione lingua">
    <div class="topbar__lang">
        <a href="<?php echo url('en/'); ?>" title="Switch to English version" tabindex="0" hreflang="en"><img src="<?php echo IMAGES_PATH; ?>/uk.svg" alt="English flag" title="English" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
        <a href="<?php echo url('/'); ?>" title="Versión italiana" tabindex="0" hreflang="it"><img src="<?php echo IMAGES_PATH; ?>/it.svg" alt="Bandera italiana" title="Italiano" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
        <a class="current" href="<?php echo url('es/'); ?>" title="Cambiar a versión en español" tabindex="0" hreflang="es"><img src="<?php echo IMAGES_PATH; ?>/es.svg" alt="Bandera española" title="Español" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
    </div>
  </div>
  
  <header class="header" role="banner">
    <div class="header__container">
      <h1 class="header__title"><a href="<?php echo url('es/'); ?>"><img src="<?php echo IMAGES_PATH; ?>/IBS_logo.png" alt="Logo IBS Lab - Innovative Banking Solutions" class="header__logo" tabindex="0" width="200" height="80" fetchpriority="high" decoding="sync"></a></h1>
        ...
        <ul class="nav__list">
          <li class="nav__item has-submenu">
            ...
            <ul class="nav__submenu">
              ...
              <li><a href="<?php echo url('es/compliance-finanziaria'); ?>" tabindex="0">Cumplimiento Financiero</a></li>
