<footer id="contatti" class="footer" aria-labelledby="contatti-heading" role="contentinfo">
    <div class="footer__columns">
        <div class="footer__col">
            ...
            </svg> info@ibslab.eu</a></p>
            <p class="footer__social-item"><a href="https://www.linkedin.com/company/ibslab" target="_blank" rel="noopener noreferrer" title="Seguici su LinkedIn"><svg
        ...
        <div class="footer__col">
            <h3>&nbsp;</h3>
            <p>
                <a href="<?php echo absoluteUrl(); ?>en/privacy-policy/">Privacy Policy</a><br><br>
<a href="<?php echo absoluteUrl(); ?>en/cookie-policy/">Cookie Policy</a>
            </p>
        </div>
    </div>
</footer>
