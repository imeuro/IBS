  <div class="topbar" aria-label="Selezione lingua">
    <div class="topbar__lang">
        ...
        <a href="<?php echo url('/'); ?>" title="Cambia a versione italiana" tabindex="0" hreflang="it"><img src="<?php echo IMAGES_PATH; ?>/it.svg" alt="Bandiera italiana" title="Italiano" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
        ...
        <ul class="nav__list">
          <li class="nav__item has-submenu">
            ...
            <ul class="nav__submenu">
              ...
              <li><a href="<?php echo url('en/compliance-finanziaria'); ?>" tabindex="0">Financial Compliance</a></li>
