  <div class="topbar" aria-label="Selezione lingua">
    <div class="topbar__lang">
        ...
        <a class="current" href="<?php echo url('it/'); ?>" title="Cambia a versione italiana" tabindex="0" hreflang="it"><img src="<?php echo IMAGES_PATH; ?>/it.svg" alt="Bandiera italiana" title="Italiano" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
