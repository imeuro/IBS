  <div class="topbar" aria-label="Selezione lingua">
    <div class="topbar__lang">
        ...
        <a class="current" href="<?php echo url('/'); ?>" title="Cambia a versione italiana" tabindex="0" hreflang="it"><img src="<?php echo IMAGES_PATH; ?>/it.svg" alt="Bandiera italiana" title="Italiano" tabindex="0" width="24" height="24" loading="lazy" decoding="async"></a>
  ...
  <header class="header" role="banner">
    <div class="header__container">
      <h1 class="header__title"><a href="<?php echo url('/'); ?>"><img src="<?php echo IMAGES_PATH; ?>/IBS_logo.png" alt="Logo IBS Lab - Innovative Banking Solutions" class="header__logo" tabindex="0" width="200" height="80" fetchpriority="high" decoding="sync"></a></h1>
        ...
        <ul class="nav__list">
          <li class="nav__item has-submenu">
            ...
            <ul class="nav__submenu">
              ...
              <li><a href="<?php echo url('it/compliance-finanziaria'); ?>" tabindex="0">Compliance Finanziaria</a></li>
