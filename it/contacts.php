          ...
          <div class="form-row">
            <div class="form-group form-group--full">
              <label class="checkbox-label">
                ...
                <span class="checkbox-text">Accetto l'<a href="<?php echo BASE_PATH; ?>/it/cookie-policy.php" target="_blank" rel="noopener">informativa sulla privacy</a> e autorizzo il trattamento dei miei dati personali <span class="required">*</span></span>
              </label>
            </div>
          </div>
